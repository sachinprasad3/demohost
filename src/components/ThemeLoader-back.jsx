...
export const applyTheme = (t) => {
  ...
  const vars = {
    ...
    "sidebar-bg": buildFinalBg(t.sidebarBg, t.sidebarBgOpacity),
...
export default function ThemeLoader() {
  useEffect(() => {
    ...
    const fetchTheme = async () => {
      try {
        const res = await axiosInstance.get("/api/theme");
        const data = res?.data; 
        ...
        // log for debugging; silent fallback otherwise
        // you can uncomment the following line while debugging CORS / network issues:
