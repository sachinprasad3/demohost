...
{siblingsArray.length !== 0 && <div className="whitebox">
  ...
  {studentDetails?.siblingDetails?.siblingInfo && (
    <div className="mt-2">
      ...
      {/* PREVIOUS SCHOOL */}
     {(studentDetails?.personalDetails?.previousSchoolAttended ||studentDetails?.personalDetails?.prevClassAttended) &&<div className="col-md-4">
        <div className="whitebox">
      ...
      <div className="col-md-4">
        <div className="whitebox">
          ...
          <InfoRow label="Other language " value={studentDetails?.personalDetails?.languageKnownOthers} />
      ...
      {groupedDocuments.length!==0 &&<div className="col-md-4">
  <div className="whitebox">
    <h4>Documents</h4>

    {Object.entries(groupedDocuments).map(([ownerType, docs]) => (
      <div key={ownerType} className="mb-4">
        ...
        <div className="row">
          {docs.map((doc) => (
            <div className="col-12 mb-3" key={doc.documentId}>
              <label className="fw-semibold">
                {doc.documentName.replace("_", " ")}
              </label>

              <div className="border rounded p-2 text-center">
                <img
  src={`${doc.storagePath}?v=${Date.now()}`}
  alt={doc.documentName}
  className="img-fluid rounded"
  style={{ maxHeight: "180px", objectFit: "contain" }}
  onClick={() =>
    window.open(`${doc.storagePath}?v=${Date.now()}`, "_blank")
  }
/>
