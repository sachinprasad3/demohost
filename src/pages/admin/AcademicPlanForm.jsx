...
import {
  useCreateUpdatePlanner,
  useGetDailylessionplanById,
...
import { hasAtLeastOneFilledField } from "./AdminTemplateForm";
...
export default function AcademicPlanForm() {
  ...
  const createUpdatePlannerMutation = useCreateUpdatePlanner();
  ...
  useEffect(() => {
    if (createUpdatePlannerMutation.isPending) {
      showLoader("Saving academic plan...");
    } else {
      hideLoader();
    }
  ...
  //   // DAILY PLAN ? ALWAYS LOAD
  //   if (daily_teaching_plan_id) {
  //     setDataSource("DAILY");
  ...
  //   // MASTER PLAN ? ONLY IF NOT EDIT
  //   if (!isEditView && dataSource !== "MASTER") {
      ...
      days: {
        ...
        [activeDay]: {
          ...
          [slot]: {
            ...
            title: [
              ...prev.days[activeDay][slot].title,
              { title: "", status: "PENDING" },
            ],
          },
        },
      ...
      <div className="container">
        <div className="addfee-head">
          ...
          <button
            ...
            onClick={() => navigate("/admin/view-academic-plan")}
          >
            View Plan
          </button>
        </div>
          ...
          <div className="formbox stapform">
            <ul>
              ...
              <li>
                <div className="form-group">
                  <label className="form-label">
                    Day Date<span className="text-danger">*</span>
                  </label>
                  <input
                    type="date"
                    className={`form-control ${
                    ...
                    min={minDate}
                    max={maxDate}
                    onChange={(e) => handleTopChange("dayDate", e.target.value)}
                  />
