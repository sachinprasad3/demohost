...
import StudentDiscountList from "../pages/admin/StudentDiscountList";
import AddStudentDiscount from "../pages/admin/AddStudentDiscount";
import StudentDiscountView from "../pages/admin/StudentDiscountView";
...
const SentNotificationList = lazy(() => import("../pages/admin/SentNotificationList"));
...
export const ADMIN_ROUTES = [
  ...
  { path: "today-enquiries", element: EnquiryListPage, label: "Enquiries" },
  ...
  { path: "student-discounts", element: StudentDiscountList, label: "Student Discounts" },
  { path: "add-student-discount", element: () => <AddStudentDiscount mode="ADD" />, label: "Add Student Discount"},
  { path: "student-discounts/edit/:id", element: () => <AddStudentDiscount mode="EDIT" /> },
  { path: "student-discounts/view/:id", element: StudentDiscountView},
  ...
  { path: "sent-notifications", element: SentNotificationList, label: "Sent Notifications" },
];
